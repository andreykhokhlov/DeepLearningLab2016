...
class Network:
    ...
    def build_network(self, input_data):
        ...
        conv_layer_1 = lasagne.layers.Conv2DLayer(network, num_filters=32, pad = 'same', filter_size=(5, 5),
                                                  nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform())
        network = lasagne.layers.MaxPool2DLayer(conv_layer_1, pool_size=(2, 2))
        conv_layer_2 = lasagne.layers.Conv2DLayer(network, num_filters=64, pad = 'same', filter_size=(5, 5),
                                                  nonlinearity=lasagne.nonlinearities.rectify, W=lasagne.init.GlorotUniform())
